...
export default function AmanProject() {
  const screens = [
    { src: '/AMAN/splash screen.png', alt: 'Splash Screen' },
    { src: '/AMAN/home page.png', alt: 'Home Page' },
    { src: '/AMAN/Registration-1.png', alt: 'Registration' },
    { src: '/AMAN/Report - personal data.png', alt: 'Report Screen' },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8 border-b border-white/10 pb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold text-white">Aman</h1>
            ...
            <h2 className="w-full text-xl text-cyan-400 mt-2 font-medium">Missing Person Reporting App</h2>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-500/10 to-transparent border-l-4 border-yellow-500 rounded-r-xl p-6 mb-12 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                The full comprehensive case study for Aman is currently being prepared and will be published soon on Behance. Meanwhile, please take a look at some of the core UI screens designed for the app below.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {screens.map((screen, index) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-slate-800 rounded-2xl aspect-[9/19] relative overflow-hidden flex items-center justify-center border border-white/10 shadow-lg group-hover:border-cyan-500/50 transition-colors">
                      <Image 
                        src={screen.src} 
                        alt={screen.alt} 
                        fill 
                        className={`object-cover ${isLast ? 'blur-sm scale-105' : 'group-hover:scale-105 transition-transform duration-500'}`} 
                      />
                      
                      {/* Dark overlay to make images stand out */}
                      ...
                      {isLast && (
                        <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center z-10 transition-colors hover:bg-black/50">
                          <span className="text-5xl font-extrabold text-white drop-shadow-lg mb-2">+30</span>
