...
export default function Projects({ isHome = false }) {
  ...
  const filteredProjects = portfolioProjects.filter(project => {
    if (isHome) {
      return ['new-minders', 'new-1', 'new-3'].includes(project.id);
    }
  ...
  return (
    <section id="projects" className={`${isHome ? 'py-10' : 'min-h-screen py-20'} bg-[#020618] overflow-hidden`}>
            ...
            {featuredProjects.map((item, idx) => {
              const CardContent = (
                <motion.div
                  ...
                  className={`bg-white/[0.03] border border-white/10 p-8 md:p-10 rounded-3xl hover:bg-white/[0.05] transition-all duration-300 relative overflow-hidden group ${item.link ? 'cursor-pointer hover:border-cyan-500/50 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]' : ''}`}
                >
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start relative z-10">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2">
                        <h3 className="text-2xl md:text-3xl font-bold text-white group-hover:text-cyan-400 transition-colors">{item.title}</h3>
                      </div>
                      ...
                      {item.link && (
                        <div className="mt-6 inline-flex items-center gap-2 text-cyan-400 font-bold group-hover:text-cyan-300 transition-colors">
                          View Project Details <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        >
            ...
            {activeFilter === 'personal' && (
              ...
              >
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 ${activeSubFilter === 'all'
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 ${activeSubFilter === 'Front-End'
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 ${activeSubFilter === 'UI/UX'
                ...
                >
                  ...
                  <div className="relative h-48 sm:h-56 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 z-20 flex flex-wrap gap-2">
                      <span className={`px-3 py-1 text-xs font-bold rounded-full backdrop-blur-md border ${project.type === 'freelance'
          ...
          {isHome && (
            <div className="mt-12 flex justify-center">
              <Link href="/projects" className="px-8 py-3 bg-cyan-500 text-white rounded-full font-bold text-lg shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:bg-cyan-400 hover:shadow-[0_0_30px_rgba(6,182,212,0.6)] transition-all">
                View All Projects
              </Link>
            </div>
          )}
